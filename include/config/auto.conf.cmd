...
ifneq "$(CC_VERSION_TEXT)" "Android (8508608, based on r450784e) clang version 14.0.7 (https://android.googlesource.com/toolchain/llvm-project 4c603efb0cca074e9238af8b4106c30add4418f6)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "./aosp-toolchain/clang/host/linux-x86/clang-r450784e/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "./aosp-toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "./aosp-toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "./aosp-toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=./aosp-toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/home/herokelc/Kernel/aosp-toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9 -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
